...
class ConservativeRiskManager(RiskManagerInterface):
    """Conservative risk manager for sports betting strategies."""
    
    def __init__(self):
        """Initialize the conservative risk manager with default configuration."""
        super().__init__()
        self.strategy_risk = {}
        self.default_config = {
            'max_loss_streak': 5,
            'max_drawdown_pct': 0.2,
            'max_exposure': 0.15,  # 15% of bankroll
